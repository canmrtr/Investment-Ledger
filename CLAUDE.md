...
- **Settings** (hamburger menüden açılır): Account (`AccountSection`), Portföy, Görünüm, Araçlar (Bakım+Export+İşlem Geçmişi), **Geri Bildirim/Destek** (`FeedbackSection` → `feedback` tablosuna RLS-korumalı insert, Sprint 28), Sistem Durumu (collapsible), Çıkış
